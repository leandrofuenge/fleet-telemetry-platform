...
> Este documento descreve a visão de produto e os serviços previstos. Para a implementação atualmente disponível, consulte `README.md` e `docs/architecture.md`.
