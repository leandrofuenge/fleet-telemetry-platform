...
-- O integration-engine-telemetry-service envia eventos via Kafka; este serviço persiste o histórico.
-- ---------------------------------------------------------------------------
...
-- Versão comprimida (Douglas-Peucker) — dados completos no integration-engine-telemetry-service.
-- ---------------------------------------------------------------------------
