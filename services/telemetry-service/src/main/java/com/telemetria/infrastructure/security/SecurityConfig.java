    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/veiculos/**").hasAnyRole("MOTORISTA", "OPERADOR", "GESTOR", "ADMIN", "SUPER_ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/v1/veiculos/**").hasAnyRole("OPERADOR", "GESTOR", "ADMIN", "SUPER_ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/v1/veiculos/**").hasAnyRole("OPERADOR", "GESTOR", "ADMIN", "SUPER_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/veiculos/**").hasAnyRole("GESTOR", "ADMIN", "SUPER_ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/v1/motoristas/**").hasAnyRole("MOTORISTA", "OPERADOR", "GESTOR", "ADMIN", "SUPER_ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/v1/motoristas/**").hasAnyRole("OPERADOR", "GESTOR", "ADMIN", "SUPER_ADMIN")
