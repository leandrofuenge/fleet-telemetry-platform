...
import com.telemetria.api.dto.request.AuthRequest;
import com.telemetria.api.dto.request.MfaConfirmRequest;
import com.telemetria.api.dto.request.MfaSetupRequest;
import com.telemetria.api.dto.request.RefreshTokenRequest;
import com.telemetria.api.dto.response.AuthResponse;
import com.telemetria.api.dto.response.MfaSetupResponse;
...
import com.telemetria.infrastructure.security.JwtService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(@RequestBody AuthRequest request) {
        ...
        try {
            ...
            usuarioService.validarAcessoDoUsuario(usuario);
            ...
            // RN-USR-002: valida MFA obrigatório para ADMIN e SUPER_ADMIN,
            // e também para perfis que o habilitaram voluntariamente.
            usuarioService.validarMfaParaLogin(usuario, request.getMfaCodigo());
    ...
    public ResponseEntity<MfaSetupResponse> iniciarMfa(@Valid @RequestBody MfaSetupRequest request) {
        return ResponseEntity.ok(usuarioService.iniciarConfiguracaoMfa(request.getLogin(), request.getSenha()));
    }

    @PostMapping("/mfa/confirm")
    public ResponseEntity<Void> confirmarMfa(@Valid @RequestBody MfaConfirmRequest request) {
        usuarioService.confirmarConfiguracaoMfa(request.getLogin(), request.getSenha(), request.getCodigo());
