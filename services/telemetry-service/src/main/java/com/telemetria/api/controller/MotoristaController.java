...
public class MotoristaController {
    ...
    public ResponseEntity<Motorista> criar(@RequestBody MotoristaDTO dto) {
        ...
        motorista.setTenantId(dto.getTenantId());
        ...
        motorista.setDataVencimentoCnh(dto.getDataVencimentoCnh());
        motorista.setDataVencimentoAso(dto.getDataVencimentoAso());
        motorista.setMoppValido(dto.getMoppValido());
