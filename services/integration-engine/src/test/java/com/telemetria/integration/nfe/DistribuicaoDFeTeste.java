...
class DistribuicaoDFeTeste {
    ...
    @Test
    void consultaNfe_comNsu_retornaDistribuicao() throws ExcecaoNfe {
        mockStubUtil();
        mockDistStub();
    ...
    @Test
    void consultaNfe_comChave_retornaDistribuicao() throws ExcecaoNfe {
        mockStubUtil();
        mockDistStub();
    ...
    @Test
    void consultaNfe_comCpf_retornaDistribuicao() throws ExcecaoNfe {
        mockStubUtil();
        mockDistStub();
