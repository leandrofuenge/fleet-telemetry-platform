...
class NfeTeste {
    ...
    // -------------------------------------------------------------------------
    // Rejeição de ConfiguracoesNfe nula (lança ExcecaoNfe antes da chamada WS)
    // -------------------------------------------------------------------------

    @Test
    void statusServico_configNula_lancaNfeException() {
        assertThrows(ExcecaoNfe.class,
    ...
    // -------------------------------------------------------------------------
    // Config sem certificado lança ExcecaoNfe (getCertificado() retorna null)
    // -------------------------------------------------------------------------
