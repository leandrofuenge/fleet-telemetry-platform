...
class CancelarTeste {
    ...
    @Test
    void eventoCancelamento_semValidacao_retornaEvento() throws ExcecaoNfe {
        mockStubUtil();
        mockAssinar();
        mockEventosStub();
    ...
    @Test
    void eventoCancelamento_retornaLoteProcessado() throws ExcecaoNfe {
        mockStubUtil();
        mockAssinar();
        mockEventosStub();
    ...
    @Test
    void eventoCancelamento_retornaAmbienteHomologacao() throws ExcecaoNfe {
        mockStubUtil();
        mockAssinar();
        mockEventosStub();
