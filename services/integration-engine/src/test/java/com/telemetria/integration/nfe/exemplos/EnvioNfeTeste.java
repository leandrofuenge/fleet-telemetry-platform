...
import com.telemetria.integration.nfe.schemas.TLocal;
...
import com.telemetria.integration.nfe.schemas.TUf;
    ...
    private static void Envia() {
        ...
        try {
            ...
            if (RetornoUtil.isRetornoAssincrono(retorno)) {
                ...
                int tentativa = 0;
                com.telemetria.integration.nfe.schemas.TRetConsReciNFe retornoNfe = null;
