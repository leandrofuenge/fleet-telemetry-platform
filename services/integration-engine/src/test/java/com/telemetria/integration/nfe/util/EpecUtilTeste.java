...
import com.telemetria.integration.nfe.dom.EventoEpec;
...
class EpecUtilTeste {
    ...
    @Test
    void montaEpec_unico_retornaTEnvEvento() throws ExcecaoNfe {
    ...
    @Test
    void montaEpec_tpEvento_ehEpec() throws ExcecaoNfe {
        TEnvEventoEpec resultado = EpecUtil.montaEpec(novoEpec(), config);
    ...
    void montaEpec_loteAcimaDe20_lancaExcecao() {
        ...
        assertThrows(ExcecaoNfe.class, () -> EpecUtil.montaEpec(lista, config));
    }

    @Test
    void montaEpec_ambiente_preenchido() throws ExcecaoNfe {
        TEnvEventoEpec resultado = EpecUtil.montaEpec(novoEpec(), config);
