...
class IbsCbsUtilTeste {
    ...
    @Test
    void deveMontarGrupoTransfCredQuandoIndTransfCredAtivo() throws ExcecaoNfe {
    ...
    @Test
    void deveMontarGrupoEstornoCredQuandoIndEstornoCredAtivo() throws ExcecaoNfe {
    ...
    @Test
    void deveMontarGrupoCredPresOperQuandoIndCredPresOperAtivo() throws ExcecaoNfe {
        CstDTO cst = montarCst("TST", true, false, false, false, false, false);
    ...
    @Test
    void deveMontarGrupoTribCompraGovQuandoIndCompraGovAtivo() throws ExcecaoNfe {
        CstDTO cst = montarCst("TST", true, false, false, false, false, false);
    ...
    @Test
    void deveAcumularTotaisEstornoEmPreencheTotais() throws ExcecaoNfe {
        CstDTO cst = montarCst("TST", true, false, false, false, false, false);
        ClassificacaoTributariaDTO ct = montarClassTrib(CC_TRIB, false, true, false);
        cst.setClassificacoesTributarias(Collections.singletonList(ct));
    ...
    @Test
    void naoDevePreencherGEstornoCredNosToatisQuandoNaoHaEstorno() throws ExcecaoNfe {
        CstDTO cst = montarCst("TST", true, false, false, false, false, false);
        ClassificacaoTributariaDTO ct = montarClassTrib(CC_TRIB, false, false, false);
        cst.setClassificacoesTributarias(Collections.singletonList(ct));
    ...
    @Test
    void naoDeveMontarGruposOpcionaisQuandoIndicadoresFalsos() throws ExcecaoNfe {
        CstDTO cst = montarCst("TST", true, false, false, false, false, false);
        ClassificacaoTributariaDTO ct = montarClassTrib(CC_TRIB, false, false, false);
        cst.setClassificacoesTributarias(Collections.singletonList(ct));
    ...
    @Test
    void naoDeveQuebrarComCstDtoSemNovosIndicadores() throws ExcecaoNfe {
