...
class ConsultaXmlTeste {
    ...
    @Test
    void consultaXml_chaveValida_retornaResultado() throws ExcecaoNfe {
        mockStubUtil();
        mockConsultaStub();
    ...
    @Test
    void consultaXml_retornaMotivo() throws ExcecaoNfe {
        mockStubUtil();
        mockConsultaStub();
    ...
    @Test
    void consultaXml_retornaAmbienteHomologacao() throws ExcecaoNfe {
        mockStubUtil();
        mockConsultaStub();
