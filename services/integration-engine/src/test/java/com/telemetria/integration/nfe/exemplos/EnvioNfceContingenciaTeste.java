...
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Dest;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Det;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Det.Imposto;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Det.Imposto.COFINS;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Det.Imposto.COFINS.COFINSAliq;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Det.Imposto.ICMS;
...
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Det.Prod;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Emit;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Ide;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Pag;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Total;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Total.ICMSTot;
import com.telemetria.integration.nfe.schemas.TNFe.InfNFe.Transp;
import com.telemetria.integration.nfe.schemas.TRetConsReciNFe;
import com.telemetria.integration.nfe.schemas.TRetEnviNFe;
import com.telemetria.integration.nfe.schemas.TUfEmi;
import com.telemetria.integration.nfe.util.ChaveUtil;
...
public class EnvioNfceContingenciaTeste {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String tipoEmissao = "9";
            //Informe o idToken
            String idToken = "000001";
            //Informe o CSC da NFCe
            String csc = "5875f1ced69b589a";
    ...
    private static Ide preencheIde(ConfiguracoesNfe config, String cnf, int numeroNFCe, String tipoEmissao, String modelo, int serie, String cDv, LocalDateTime dataEmissao) throws NfeException {
        ...
        ide.setDhCont(XmlNfeUtil.dataNfe(dataEmissao,null));
