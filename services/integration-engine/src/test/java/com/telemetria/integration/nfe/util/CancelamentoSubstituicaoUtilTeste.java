...
class CancelamentoSubstituicaoUtilTeste {
    ...
    @Test
    void montaCancelamento_retornaTEnvEvento() throws ExcecaoNfe {
    ...
    @Test
    void montaCancelamento_tpEvento_ehCancelamentoSubstituicao() throws ExcecaoNfe {
        TEnvEventoCancelamentoSubstituicao resultado = CancelamentoSubstituicaoUtil.montaCancelamento(novoEvento(), config);
    ...
    @Test
    void montaCancelamento_chaveSubstituta_preenchida() throws ExcecaoNfe {
        TEnvEventoCancelamentoSubstituicao resultado = CancelamentoSubstituicaoUtil.montaCancelamento(novoEvento(), config);
    ...
    @Test
    void montaCancelamento_descEvento_cancelamentoPorSubstituicao() throws ExcecaoNfe {
        TEnvEventoCancelamentoSubstituicao resultado = CancelamentoSubstituicaoUtil.montaCancelamento(novoEvento(), config);
    ...
    void montaCancelamento_loteAcimaDe20_lancaExcecao() {
        ...
        assertThrows(ExcecaoNfe.class, () -> CancelamentoSubstituicaoUtil.montaCancelamento(lista, config));
    }
}
