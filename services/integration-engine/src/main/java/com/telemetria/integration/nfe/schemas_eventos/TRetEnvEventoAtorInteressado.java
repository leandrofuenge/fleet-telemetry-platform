...
public class TRetEnvEventoAtorInteressado {
    ...
    protected List<TRetEventoAtorInteressado> retEvento;
     ...
     * 
     */
    public List<TRetEventoAtorInteressado> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoAtorInteressado>();
        }
