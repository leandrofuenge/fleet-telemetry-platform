...
public class TRetEnvEventoCancelamentoConciliacaoFinanceira {
    ...
    protected List<TRetEventoCancelamentoConciliacaoFinanceira> retEvento;
     ...
     * 
     */
    public List<TRetEventoCancelamentoConciliacaoFinanceira> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoCancelamentoConciliacaoFinanceira>();
        }
