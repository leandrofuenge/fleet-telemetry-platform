...
public class DetEvento112140 {
    ...
    @XmlElement(required = true)
    protected List<DetEvento112140.GItemNaoFornecido> gItemNaoFornecido;
     ...
     * {@link DetEvento112140.GItemNaoFornecido }
     * 
     * 
     */
    public List<DetEvento112140.GItemNaoFornecido> getGItemNaoFornecido() {
        if (gItemNaoFornecido == null) {
            gItemNaoFornecido = new ArrayList<DetEvento112140.GItemNaoFornecido>();
        }
    ...
    public static class GItemNaoFornecido {
        ...
        @XmlElement(required = true)
        protected DetEvento112140.GItemNaoFornecido.GControleEstoque gControleEstoque;
         ...
         * @return
         *     possible object is
         *     {@link DetEvento112140.GItemNaoFornecido.GControleEstoque }
         *     
         */
        public DetEvento112140.GItemNaoFornecido.GControleEstoque getGControleEstoque() {
         ...
         *     
         */
        public void setGControleEstoque(DetEvento112140.GItemNaoFornecido.GControleEstoque value) {
