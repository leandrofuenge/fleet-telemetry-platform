...
public class DetEvento112130 {
    ...
    @XmlElement(required = true)
    protected List<DetEvento112130.GPerecimento> gPerecimento;
     ...
     * {@link DetEvento112130.GPerecimento }
     * 
     * 
     */
    public List<DetEvento112130.GPerecimento> getGPerecimento() {
        if (gPerecimento == null) {
            gPerecimento = new ArrayList<DetEvento112130.GPerecimento>();
        }
    ...
    public static class GPerecimento {
        ...
        @XmlElement(required = true)
        protected DetEvento112130.GPerecimento.GControleEstoque gControleEstoque;
         ...
         * @return
         *     possible object is
         *     {@link DetEvento112130.GPerecimento.GControleEstoque }
         *     
         */
        public DetEvento112130.GPerecimento.GControleEstoque getGControleEstoque() {
         ...
         *     
         */
        public void setGControleEstoque(DetEvento112130.GPerecimento.GControleEstoque value) {
