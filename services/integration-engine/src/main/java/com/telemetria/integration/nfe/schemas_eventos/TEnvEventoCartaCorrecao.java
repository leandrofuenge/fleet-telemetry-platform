...
public class TEnvEventoCartaCorrecao {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoCartaCorrecao> evento;
     ...
     * 
     */
    public List<TEventoCartaCorrecao> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoCartaCorrecao>();
        }
        return this.evento;
    }
