...
public class TRetEnvEventoComprovanteEntrega {
    ...
    protected List<TRetEventoComprovanteEntrega> retEvento;
     ...
     * 
     */
    public List<TRetEventoComprovanteEntrega> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoComprovanteEntrega>();
        }
