...
public class TEventoInsucessoEntrega {

    @XmlElement(required = true)
    protected TEventoInsucessoEntrega.InfEvento infEvento;
     ...
     * @return
     *     possible object is
     *     {@link TEventoInsucessoEntrega.InfEvento }
     *     
     */
    public TEventoInsucessoEntrega.InfEvento getInfEvento() {
        return infEvento;
    }
     ...
     *     
     */
    public void setInfEvento(TEventoInsucessoEntrega.InfEvento value) {
    ...
    public static class InfEvento {
        ...
        @XmlElement(namespace = "http://www.portalfiscal.inf.br/nfe", required = true)
        protected DetEventoInsucessoEntrega detEvento;
         ...
         * @return
         *     possible object is
         *     {@link DetEventoInsucessoEntrega }
         *     
         */
        public DetEventoInsucessoEntrega getDetEvento() {
            return detEvento;
        }
         ...
         *     
         */
        public void setDetEvento(DetEventoInsucessoEntrega value) {
