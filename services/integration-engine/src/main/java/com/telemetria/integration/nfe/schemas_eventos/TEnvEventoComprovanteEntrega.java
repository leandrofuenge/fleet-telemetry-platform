...
public class TEnvEventoComprovanteEntrega {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoComprovanteEntrega> evento;
     ...
     * 
     */
    public List<TEventoComprovanteEntrega> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoComprovanteEntrega>();
        }
        return this.evento;
    }
