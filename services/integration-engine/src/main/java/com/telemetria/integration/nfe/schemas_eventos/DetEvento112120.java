...
public class DetEvento112120 {
    ...
    @XmlElement(required = true)
    protected List<DetEvento112120.GConsumo> gConsumo;
     ...
     * {@link DetEvento112120.GConsumo }
     * 
     * 
     */
    public List<DetEvento112120.GConsumo> getGConsumo() {
        if (gConsumo == null) {
            gConsumo = new ArrayList<DetEvento112120.GConsumo>();
        }
    ...
    public static class GConsumo {
        ...
        @XmlElement(required = true)
        protected DetEvento112120.GConsumo.GControleEstoque gControleEstoque;
         ...
         * @return
         *     possible object is
         *     {@link DetEvento112120.GConsumo.GControleEstoque }
         *     
         */
        public DetEvento112120.GConsumo.GControleEstoque getGControleEstoque() {
         ...
         *     
         */
        public void setGControleEstoque(DetEvento112120.GConsumo.GControleEstoque value) {
