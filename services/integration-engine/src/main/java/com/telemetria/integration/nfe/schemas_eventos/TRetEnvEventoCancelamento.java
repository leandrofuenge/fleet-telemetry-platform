...
public class TRetEnvEventoCancelamento {
    ...
    protected List<TRetEventoCancelamento> retEvento;
     ...
     * 
     */
    public List<TRetEventoCancelamento> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoCancelamento>();
        }
