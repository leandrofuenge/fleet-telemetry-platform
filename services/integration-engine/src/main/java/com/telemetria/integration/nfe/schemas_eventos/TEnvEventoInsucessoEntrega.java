...
public class TEnvEventoInsucessoEntrega {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoInsucessoEntrega> evento;
     ...
     * 
     */
    public List<TEventoInsucessoEntrega> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoInsucessoEntrega>();
        }
        return this.evento;
    }
