...
public class TEnvEventoCancelamentoSubstituicao {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoCancelamentoSubstituicao> evento;
     ...
     * 
     */
    public List<TEventoCancelamentoSubstituicao> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoCancelamentoSubstituicao>();
        }
        return this.evento;
    }
