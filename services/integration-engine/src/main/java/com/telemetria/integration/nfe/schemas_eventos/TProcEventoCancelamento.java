...
public class TProcEventoCancelamento {

    @XmlElement(required = true)
    protected TEventoCancelamento evento;
    @XmlElement(required = true)
    protected TRetEventoCancelamento retEvento;
     ...
     * @return
     *     possible object is
     *     {@link TEventoCancelamento }
     *     
     */
    public TEventoCancelamento getEvento() {
        return evento;
    }
     ...
     *     
     */
    public void setEvento(TEventoCancelamento value) {
        this.evento = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TRetEventoCancelamento }
     *     
     */
    public TRetEventoCancelamento getRetEvento() {
        return retEvento;
    }
     ...
     *     
     */
    public void setRetEvento(TRetEventoCancelamento value) {
