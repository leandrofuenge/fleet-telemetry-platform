...
public class TRetEnvEventoCancelamentoComprovanteEntrega {
    ...
    protected List<TRetEventoCancelamentoComprovanteEntrega> retEvento;
     ...
     * 
     */
    public List<TRetEventoCancelamentoComprovanteEntrega> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoCancelamentoComprovanteEntrega>();
        }
