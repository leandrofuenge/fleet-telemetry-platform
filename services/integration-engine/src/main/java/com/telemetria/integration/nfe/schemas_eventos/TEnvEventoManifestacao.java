...
public class TEnvEventoManifestacao {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoManifestacao> evento;
     ...
     * 
     */
    public List<TEventoManifestacao> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoManifestacao>();
        }
        return this.evento;
    }
