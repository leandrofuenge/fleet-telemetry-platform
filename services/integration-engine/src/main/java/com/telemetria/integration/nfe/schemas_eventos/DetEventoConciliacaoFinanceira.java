...
public class DetEventoConciliacaoFinanceira {
    ...
    @XmlElement(namespace = "http://www.portalfiscal.inf.br/nfe", required = true)
    protected List<DetEventoConciliacaoFinanceira.DetPag> detPag;
     ...
     * {@link DetEventoConciliacaoFinanceira.DetPag }
     * 
     * 
     */
    public List<DetEventoConciliacaoFinanceira.DetPag> getDetPag() {
        if (detPag == null) {
            detPag = new ArrayList<DetEventoConciliacaoFinanceira.DetPag>();
        }
        return this.detPag;
    }
