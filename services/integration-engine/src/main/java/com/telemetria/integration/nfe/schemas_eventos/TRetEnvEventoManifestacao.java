...
public class TRetEnvEventoManifestacao {
    ...
    protected List<TRetEventoManifestacao> retEvento;
     ...
     * 
     */
    public List<TRetEventoManifestacao> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoManifestacao>();
        }
