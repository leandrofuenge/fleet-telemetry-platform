...
public class DetEvento211130 {
    ...
    @XmlElement(required = true)
    protected List<DetEvento211130.GImobilizacao> gImobilizacao;
     ...
     * {@link DetEvento211130.GImobilizacao }
     * 
     * 
     */
    public List<DetEvento211130.GImobilizacao> getGImobilizacao() {
        if (gImobilizacao == null) {
            gImobilizacao = new ArrayList<DetEvento211130.GImobilizacao>();
        }
    ...
    public static class GImobilizacao {
        ...
        @XmlElement(required = true)
        protected DetEvento211130.GImobilizacao.GControleEstoque gControleEstoque;
         ...
         * @return
         *     possible object is
         *     {@link DetEvento211130.GImobilizacao.GControleEstoque }
         *     
         */
        public DetEvento211130.GImobilizacao.GControleEstoque getGControleEstoque() {
         ...
         *     
         */
        public void setGControleEstoque(DetEvento211130.GImobilizacao.GControleEstoque value) {
