...
public class TRetEnvEventoCancelamentoSubstituicao {
    ...
    protected List<TRetEventoCancelamentoSubstituicao> retEvento;
     ...
     * 
     */
    public List<TRetEventoCancelamentoSubstituicao> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoCancelamentoSubstituicao>();
        }
