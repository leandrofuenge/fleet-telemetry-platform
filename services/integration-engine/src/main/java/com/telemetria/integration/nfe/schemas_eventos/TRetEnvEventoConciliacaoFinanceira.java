...
public class TRetEnvEventoConciliacaoFinanceira {
    ...
    protected List<TRetEventoConciliacaoFinanceira> retEvento;
     ...
     * 
     */
    public List<TRetEventoConciliacaoFinanceira> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoConciliacaoFinanceira>();
        }
