...
public class DetEvento211124 {
    ...
    @XmlElement(required = true)
    protected List<DetEvento211124.GPerecimento> gPerecimento;
     ...
     * {@link DetEvento211124.GPerecimento }
     * 
     * 
     */
    public List<DetEvento211124.GPerecimento> getGPerecimento() {
        if (gPerecimento == null) {
            gPerecimento = new ArrayList<DetEvento211124.GPerecimento>();
        }
    ...
    public static class GPerecimento {
        ...
        @XmlElement(required = true)
        protected DetEvento211124.GPerecimento.GControleEstoque gControleEstoque;
         ...
         * @return
         *     possible object is
         *     {@link DetEvento211124.GPerecimento.GControleEstoque }
         *     
         */
        public DetEvento211124.GPerecimento.GControleEstoque getGControleEstoque() {
         ...
         *     
         */
        public void setGControleEstoque(DetEvento211124.GPerecimento.GControleEstoque value) {
