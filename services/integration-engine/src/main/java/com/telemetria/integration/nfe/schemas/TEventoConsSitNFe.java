...
public class TEventoConsSitNFe {

    @XmlElement(required = true)
    protected TEventoConsSitNFe.InfEvento infEvento;
     ...
     * @return
     *     possible object is
     *     {@link TEventoConsSitNFe.InfEvento }
     *     
     */
    public TEventoConsSitNFe.InfEvento getInfEvento() {
        return infEvento;
    }
     ...
     *     
     */
    public void setInfEvento(TEventoConsSitNFe.InfEvento value) {
    ...
    public static class InfEvento {
        ...
        @XmlElement(namespace = "http://www.portalfiscal.inf.br/nfe", required = true)
        protected TEventoConsSitNFe.InfEvento.DetEvento detEvento;
         ...
         * @return
         *     possible object is
         *     {@link TEventoConsSitNFe.InfEvento.DetEvento }
         *     
         */
        public TEventoConsSitNFe.InfEvento.DetEvento getDetEvento() {
            return detEvento;
        }
         ...
         *     
         */
        public void setDetEvento(TEventoConsSitNFe.InfEvento.DetEvento value) {
