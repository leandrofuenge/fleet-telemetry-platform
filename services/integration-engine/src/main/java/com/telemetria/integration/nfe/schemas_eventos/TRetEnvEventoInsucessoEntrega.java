...
public class TRetEnvEventoInsucessoEntrega {
    ...
    protected List<TRetEventoInsucessoEntrega> retEvento;
     ...
     * 
     */
    public List<TRetEventoInsucessoEntrega> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoInsucessoEntrega>();
        }
