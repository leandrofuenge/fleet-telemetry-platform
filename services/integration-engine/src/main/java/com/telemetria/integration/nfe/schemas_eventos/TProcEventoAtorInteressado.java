...
public class TProcEventoAtorInteressado {

    @XmlElement(required = true)
    protected TEventoAtorInteressado evento;
    @XmlElement(required = true)
    protected TRetEventoAtorInteressado retEvento;
     ...
     * @return
     *     possible object is
     *     {@link TEventoAtorInteressado }
     *     
     */
    public TEventoAtorInteressado getEvento() {
        return evento;
    }
     ...
     *     
     */
    public void setEvento(TEventoAtorInteressado value) {
        this.evento = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TRetEventoAtorInteressado }
     *     
     */
    public TRetEventoAtorInteressado getRetEvento() {
        return retEvento;
    }
     ...
     *     
     */
    public void setRetEvento(TRetEventoAtorInteressado value) {
