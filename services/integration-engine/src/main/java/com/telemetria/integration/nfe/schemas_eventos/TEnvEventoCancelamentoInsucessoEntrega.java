...
public class TEnvEventoCancelamentoInsucessoEntrega {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoCancelamentoInsucessoEntrega> evento;
     ...
     * 
     */
    public List<TEventoCancelamentoInsucessoEntrega> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoCancelamentoInsucessoEntrega>();
        }
        return this.evento;
    }
