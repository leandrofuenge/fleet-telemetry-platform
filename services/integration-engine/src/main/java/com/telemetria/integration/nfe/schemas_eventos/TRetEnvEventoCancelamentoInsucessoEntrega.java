...
public class TRetEnvEventoCancelamentoInsucessoEntrega {
    ...
    protected List<TRetEventoCancelamentoInsucessoEntrega> retEvento;
     ...
     * 
     */
    public List<TRetEventoCancelamentoInsucessoEntrega> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoCancelamentoInsucessoEntrega>();
        }
