...
public class TProcEventoManifestacao {

    @XmlElement(required = true)
    protected TEventoManifestacao evento;
    @XmlElement(required = true)
    protected TRetEventoManifestacao retEvento;
     ...
     * @return
     *     possible object is
     *     {@link TEventoManifestacao }
     *     
     */
    public TEventoManifestacao getEvento() {
        return evento;
    }
     ...
     *     
     */
    public void setEvento(TEventoManifestacao value) {
        this.evento = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TRetEventoManifestacao }
     *     
     */
    public TRetEventoManifestacao getRetEvento() {
        return retEvento;
    }
     ...
     *     
     */
    public void setRetEvento(TRetEventoManifestacao value) {
