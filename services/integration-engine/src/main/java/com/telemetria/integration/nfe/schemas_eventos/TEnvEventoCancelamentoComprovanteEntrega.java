...
public class TEnvEventoCancelamentoComprovanteEntrega {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoCancelamentoComprovanteEntrega> evento;
     ...
     * 
     */
    public List<TEventoCancelamentoComprovanteEntrega> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoCancelamentoComprovanteEntrega>();
        }
        return this.evento;
    }
