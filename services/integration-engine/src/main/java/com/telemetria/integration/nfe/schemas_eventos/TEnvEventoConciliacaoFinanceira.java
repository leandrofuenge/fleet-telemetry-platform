...
public class TEnvEventoConciliacaoFinanceira {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoConciliacaoFinanceira> evento;
     ...
     * 
     */
    public List<TEventoConciliacaoFinanceira> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoConciliacaoFinanceira>();
        }
        return this.evento;
    }
