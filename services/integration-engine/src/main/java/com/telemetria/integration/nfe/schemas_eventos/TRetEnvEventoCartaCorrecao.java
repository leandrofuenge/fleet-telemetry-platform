...
public class TRetEnvEventoCartaCorrecao {
    ...
    protected List<TRetEventoCartaCorrecao> retEvento;
     ...
     * 
     */
    public List<TRetEventoCartaCorrecao> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoCartaCorrecao>();
        }
