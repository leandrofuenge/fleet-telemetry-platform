...
public class TEnvEventoCancelamento {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoCancelamento> evento;
     ...
     * 
     */
    public List<TEventoCancelamento> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoCancelamento>();
        }
        return this.evento;
    }
