...
public class TProcEventoCartaCorrecao {

    @XmlElement(required = true)
    protected TEventoCartaCorrecao evento;
    @XmlElement(required = true)
    protected TRetEventoCartaCorrecao retEvento;
     ...
     * @return
     *     possible object is
     *     {@link TEventoCartaCorrecao }
     *     
     */
    public TEventoCartaCorrecao getEvento() {
        return evento;
    }
     ...
     *     
     */
    public void setEvento(TEventoCartaCorrecao value) {
        this.evento = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TRetEventoCartaCorrecao }
     *     
     */
    public TRetEventoCartaCorrecao getRetEvento() {
        return retEvento;
    }
     ...
     *     
     */
    public void setRetEvento(TRetEventoCartaCorrecao value) {
