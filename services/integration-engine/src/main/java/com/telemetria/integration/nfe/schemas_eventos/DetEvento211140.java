...
public class DetEvento211140 {
    ...
    @XmlElement(required = true)
    protected List<DetEvento211140.GConsumoComb> gConsumoComb;
     ...
     * {@link DetEvento211140.GConsumoComb }
     * 
     * 
     */
    public List<DetEvento211140.GConsumoComb> getGConsumoComb() {
        if (gConsumoComb == null) {
            gConsumoComb = new ArrayList<DetEvento211140.GConsumoComb>();
        }
    ...
    public static class GConsumoComb {
        ...
        @XmlElement(required = true)
        protected DetEvento211140.GConsumoComb.GControleEstoque gControleEstoque;
         ...
         * @return
         *     possible object is
         *     {@link DetEvento211140.GConsumoComb.GControleEstoque }
         *     
         */
        public DetEvento211140.GConsumoComb.GControleEstoque getGControleEstoque() {
         ...
         *     
         */
        public void setGControleEstoque(DetEvento211140.GConsumoComb.GControleEstoque value) {
