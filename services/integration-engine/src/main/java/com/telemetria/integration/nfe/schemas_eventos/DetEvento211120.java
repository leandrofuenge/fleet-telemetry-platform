...
package com.telemetria.integration.nfe.schemas_eventos;
...
public class DetEvento211120 {
    ...
    @XmlElement(required = true)
    protected List<DetEvento211120.GConsumo> gConsumo;
     ...
     * {@link DetEvento211120.GConsumo }
     * 
     * 
     */
    public List<DetEvento211120.GConsumo> getGConsumo() {
        if (gConsumo == null) {
            gConsumo = new ArrayList<DetEvento211120.GConsumo>();
        }
    ...
    public static class GConsumo {
        ...
        @XmlElement(required = true)
        protected DetEvento211120.GConsumo.GControleEstoque gControleEstoque;
        @XmlElement(name = "DFeReferenciado", required = true)
        protected DetEvento211120.GConsumo.DFeReferenciado dFeReferenciado;
         ...
         * @return
         *     possible object is
         *     {@link DetEvento211120.GConsumo.GControleEstoque }
         *     
         */
        public DetEvento211120.GConsumo.GControleEstoque getGControleEstoque() {
         ...
         *     
         */
        public void setGControleEstoque(DetEvento211120.GConsumo.GControleEstoque value) {
         ...
         * @return
         *     possible object is
         *     {@link DetEvento211120.GConsumo.DFeReferenciado }
         *     
         */
        public DetEvento211120.GConsumo.DFeReferenciado getDFeReferenciado() {
         ...
         *     
         */
        public void setDFeReferenciado(DetEvento211120.GConsumo.DFeReferenciado value) {
