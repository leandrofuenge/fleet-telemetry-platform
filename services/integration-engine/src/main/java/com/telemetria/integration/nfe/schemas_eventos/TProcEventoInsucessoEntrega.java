...
public class TProcEventoInsucessoEntrega {

    @XmlElement(required = true)
    protected TEventoInsucessoEntrega evento;
    @XmlElement(required = true)
    protected TRetEventoInsucessoEntrega retEvento;
     ...
     * @return
     *     possible object is
     *     {@link TEventoInsucessoEntrega }
     *     
     */
    public TEventoInsucessoEntrega getEvento() {
        return evento;
    }
     ...
     *     
     */
    public void setEvento(TEventoInsucessoEntrega value) {
        this.evento = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TRetEventoInsucessoEntrega }
     *     
     */
    public TRetEventoInsucessoEntrega getRetEvento() {
        return retEvento;
    }
     ...
     *     
     */
    public void setRetEvento(TRetEventoInsucessoEntrega value) {
