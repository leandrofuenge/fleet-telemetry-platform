...
public class TProcEventoGenerico {

    @XmlElement(required = true)
    protected TEventoGenerico evento;
    @XmlElement(required = true)
    protected TRetEventoGenerico retEvento;
     ...
     * @return
     *     possible object is
     *     {@link TEventoGenerico }
     *     
     */
    public TEventoGenerico getEvento() {
        return evento;
    }
     ...
     *     
     */
    public void setEvento(TEventoGenerico value) {
        this.evento = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TRetEventoGenerico }
     *     
     */
    public TRetEventoGenerico getRetEvento() {
        return retEvento;
    }
     ...
     *     
     */
    public void setRetEvento(TRetEventoGenerico value) {
