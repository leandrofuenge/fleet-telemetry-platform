...
public class TRetEnvEventoGenerico {
    ...
    protected List<TRetEventoGenerico> retEvento;
     ...
     * 
     */
    public List<TRetEventoGenerico> getRetEvento() {
        if (retEvento == null) {
            retEvento = new ArrayList<TRetEventoGenerico>();
        }
