...
|---------------------------------------------------------------|----------------------------------------------|
| `com.telemetria.integration.nfe.schema_4.enviNFe.*`                 | `com.telemetria.integration.nfe.schemas.*`         |
| `com.telemetria.integration.nfe.schema_4.consReciNFe.*`             | `com.telemetria.integration.nfe.schemas.*`         |
| `com.telemetria.integration.nfe.schema_4.consSitNFe.*`              | `com.telemetria.integration.nfe.schemas.*`         |
| `com.telemetria.integration.nfe.schema_4.consStatServ.*`            | `com.telemetria.integration.nfe.schemas.*`         |
| `com.telemetria.integration.nfe.schema_4.inutNFe.*`                 | `com.telemetria.integration.nfe.schemas.*`         |
| `com.telemetria.integration.nfe.schema_4.comum.*`                   | `com.telemetria.integration.nfe.schemas.*`         |
| `com.telemetria.integration.nfe.schema.consCad.*`                   | `com.telemetria.integration.nfe.schemas.*`         |
| `com.telemetria.integration.nfe.schema.distDFe.*`                   | `com.telemetria.integration.nfe.schemas.*`         |
| `com.telemetria.integration.nfe.schema.resNFe.*`                    | `com.telemetria.integration.nfe.schemas.*`         |
| `com.telemetria.integration.nfe.schema.comum.*`                     | `com.telemetria.integration.nfe.schemas.*`         |
| `com.telemetria.integration.nfe.schema.cce.*`                       | `com.telemetria.integration.nfe.schemas_eventos.*` |
...
| `com.telemetria.integration.nfe.schema.eventoCancNFe.*`             | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.envEventoCancSubst.*`        | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.envConfRecebto.*`            | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.confRecebto.*`               | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.envEpec.*`                   | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.eventoGenerico.*`            | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.envEventoAtorInteressado.*`  | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.envEventoEConf.*`            | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.envEventoCancEConf.*`        | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.envEventoInsucessoNFe.*`     | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.envEventoCancInsucessoNFe.*` | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.envEventoEntregaNFe.*`       | `com.telemetria.integration.nfe.schemas_eventos.*` |
| `com.telemetria.integration.nfe.schema.envEventoCancEntregaNFe.*`   | `com.telemetria.integration.nfe.schemas_eventos.*` |
...
|----------------------------------------------------------|-------------------------------------------------------|--------|
| `com.telemetria.integration.nfe.schema.resevento.ResEvento`    | `com.telemetria.integration.nfe.schemas_eventos.ResumoEvento` | Nome da classe foi normalizado |
| `com.telemetria.integration.nfe.schema_4.consSitNFe.TProcEvento` | `com.telemetria.integration.nfe.schemas.TProcEventoConsSitNFe` | Conflito com `TProcEvento*` de `schemas_eventos` |
| `com.telemetria.integration.nfe.schema.envcce.TretEvento`      | `com.telemetria.integration.nfe.schemas_eventos.TRetEventoCartaCorrecao` | Padronização de capitalização + sufixo de evento |
| `com.telemetria.integration.nfe.schema.envConfRecebto.TretEvento` | `com.telemetria.integration.nfe.schemas_eventos.TRetEventoManifestacao` | idem |
...
| `com.telemetria.integration.nfe.schema.evento112110.DetEvento.GConsumo`       | `com.telemetria.integration.nfe.schemas_eventos.DetEvento112110.GConsumo` |
| `com.telemetria.integration.nfe.schema.evento211110.DetEvento.GCredPres`      | `com.telemetria.integration.nfe.schemas_eventos.DetEvento211110.GCredPres` |
...
1. **Imports wildcard `import com.telemetria.integration.nfe.schema_4.*;`** — o script substitui o prefixo do package mas mantém o `*`. Se o wildcard importava de um único package e agora há ambiguidade, resolva os imports individualmente.
