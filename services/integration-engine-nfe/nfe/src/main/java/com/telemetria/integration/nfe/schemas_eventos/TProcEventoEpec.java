...
public class TProcEventoEpec {

    @XmlElement(required = true)
    protected TEventoEpec evento;
    @XmlElement(required = true)
    protected TRetEventoEpec retEvento;
     ...
     *     
     */
    public void setEvento(TEventoEpec value) {
        this.evento = value;
    }
     ...
     *     
     */
    public TRetEventoEpec getRetEvento() {
        return retEvento;
    }
     ...
     *     
     */
    public void setRetEvento(TRetEventoEpec value) {
