...
public class TEnvEventoCancelamentoConciliacaoFinanceira {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoCancelamentoConciliacaoFinanceira> evento;
     ...
     * 
     */
    public List<TEventoCancelamentoConciliacaoFinanceira> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoCancelamentoConciliacaoFinanceira>();
        }
        return this.evento;
    }
