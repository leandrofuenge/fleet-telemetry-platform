...
public class DetEvento211150 {
    ...
    @XmlElement(required = true)
    protected List<DetEvento211150.GCredito> gCredito;
     ...
     * {@link DetEvento211150.GCredito }
     * 
     * 
     */
    public List<DetEvento211150.GCredito> getGCredito() {
        if (gCredito == null) {
            gCredito = new ArrayList<DetEvento211150.GCredito>();
        }
