...
public class TEnvEventoAtorInteressado {

    @XmlElement(required = true)
    protected String idLote;
    @XmlElement(required = true)
    protected List<TEventoAtorInteressado> evento;
     ...
     * 
     */
    public List<TEventoAtorInteressado> getEvento() {
        if (evento == null) {
            evento = new ArrayList<TEventoAtorInteressado>();
        }
        return this.evento;
    }
