...
public class TRetConsSitNFe {
    ...
    protected List<TProcEventoConsSitNFe> procEventoNFe;
     ...
     * {@link TProcEventoConsSitNFe }
     * 
     * 
     */
    public List<TProcEventoConsSitNFe> getProcEventoNFe() {
        if (procEventoNFe == null) {
            procEventoNFe = new ArrayList<TProcEventoConsSitNFe>();
        }
