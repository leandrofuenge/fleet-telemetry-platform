 ...
 */
package com.telemetria.integration.nfe.codigo.gerado.wsdl.NFeStatusServico4;
...
public class NFeStatusServico4Stub extends org.apache.axis2.client.Stub {
    ...
    public NFeStatusServico4Stub() throws org.apache.axis2.AxisFault {
        this("https://nfe.fazenda.sp.gov.br/ws/nfestatusservico4.asmx");
    }
    ...
    private void populateAxisService() throws org.apache.axis2.AxisFault {
        ...
        _service = new org.apache.axis2.description.AxisService(
                "br/com/swconsultoria/nfe/wsdl/NFeStatusServico4" + getUniqueSuffix());
     ...
     * @see br.com.swconsultoria.www.nfe_400.wsdl.NFeStatusServico4.NFeStatusServico4#nfeStatusServicoNF
     * @param nfeDadosMsg0
     */
    public NFeStatusServico4Stub.NfeResultMsg nfeStatusServicoNF(
        NFeStatusServico4Stub.NfeDadosMsg nfeDadosMsg0)
        ...
        try {
            ...
            java.lang.Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    NFeStatusServico4Stub.NfeResultMsg.class);

            return (NFeStatusServico4Stub.NfeResultMsg) object;
     ...
     * Consulta Status do Serviço
     * @see br.com.swconsultoria.www.nfe_400.wsdl.NFeStatusServico4.NFeStatusServico4#startnfeStatusServicoNF
     * @param nfeDadosMsg0
     */
    public void startnfeStatusServicoNF(
        NFeStatusServico4Stub.NfeDadosMsg nfeDadosMsg0,
        final NFeStatusServico4CallbackHandler callback)
        throws java.rmi.RemoteException {
        org.apache.axis2.client.OperationClient _operationClient = _serviceClient.createClient(_operations[0].getName());
        _operationClient.getOptions()
                        .setAction("http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4/nfeStatusServicoNF");
                ...
                public void onMessage(
                    ...
                    try {
                        ...
                        java.lang.Object object = fromOM(resultEnv.getBody()
                                                                  .getFirstElement(),
                                NFeStatusServico4Stub.NfeResultMsg.class);
                        callback.receiveResultnfeStatusServicoNF((NFeStatusServico4Stub.NfeResultMsg) object);
    ...
    private org.apache.axiom.om.OMElement toOM(
        NFeStatusServico4Stub.NfeDadosMsg param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(NFeStatusServico4Stub.NfeDadosMsg.MY_QNAME,
    ...
    private org.apache.axiom.om.OMElement toOM(
        NFeStatusServico4Stub.NfeResultMsg param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(NFeStatusServico4Stub.NfeResultMsg.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    ...
                    NFeStatusServico4Stub.NfeDadosMsg.MY_QNAME,
                    factory));
    ...
    private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
        ...
        try {
            if (NFeStatusServico4Stub.NfeDadosMsg.class.equals(
                        type)) {
                return NFeStatusServico4Stub.NfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }

            if (NFeStatusServico4Stub.NfeResultMsg.class.equals(
                        type)) {
                return NFeStatusServico4Stub.NfeResultMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
