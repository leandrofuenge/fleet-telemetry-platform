 ...
 */
package com.telemetria.integration.nfe.codigo.gerado.wsdl.NFeInutilizacao;
...
public class NFeInutilizacao4Stub extends org.apache.axis2.client.Stub {
    ...
    public NFeInutilizacao4Stub() throws org.apache.axis2.AxisFault {
        this("https://nfe.fazenda.sp.gov.br/ws/nfeinutilizacao4.asmx");
    }
     ...
     * @see br.com.swconsultoria.www.nfe_400.wsdl.NFeInutilizacao.NFeInutilizacao4#nfeInutilizacaoNF
     * @param nfeDadosMsg0
     */
    public NFeInutilizacao4Stub.NfeResultMsg nfeInutilizacaoNF(
        NFeInutilizacao4Stub.NfeDadosMsg nfeDadosMsg0)
        ...
        try {
            ...
            java.lang.Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    NFeInutilizacao4Stub.NfeResultMsg.class);

            return (NFeInutilizacao4Stub.NfeResultMsg) object;
     ...
     * Inutilização de numeração de NF-e
     * @see br.com.swconsultoria.www.nfe_400.wsdl.NFeInutilizacao.NFeInutilizacao4#startnfeInutilizacaoNF
     * @param nfeDadosMsg0
     */
    public void startnfeInutilizacaoNF(
        NFeInutilizacao4Stub.NfeDadosMsg nfeDadosMsg0,
        final NFeInutilizacao4CallbackHandler callback)
        throws java.rmi.RemoteException {
        org.apache.axis2.client.OperationClient _operationClient = _serviceClient.createClient(_operations[0].getName());
        _operationClient.getOptions()
                        .setAction("http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4/nfeInutilizacaoNF");
                ...
                public void onMessage(
                    ...
                    try {
                        ...
                        java.lang.Object object = fromOM(resultEnv.getBody()
                                                                  .getFirstElement(),
                                NFeInutilizacao4Stub.NfeResultMsg.class);
                        callback.receiveResultnfeInutilizacaoNF((NFeInutilizacao4Stub.NfeResultMsg) object);
    ...
    private org.apache.axiom.om.OMElement toOM(
        NFeInutilizacao4Stub.NfeDadosMsg param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(NFeInutilizacao4Stub.NfeDadosMsg.MY_QNAME,
    ...
    private org.apache.axiom.om.OMElement toOM(
        NFeInutilizacao4Stub.NfeResultMsg param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(NFeInutilizacao4Stub.NfeResultMsg.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    ...
                    NFeInutilizacao4Stub.NfeDadosMsg.MY_QNAME,
                    factory));
    ...
    private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
        ...
        try {
            if (NFeInutilizacao4Stub.NfeDadosMsg.class.equals(
                        type)) {
                return NFeInutilizacao4Stub.NfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }

            if (NFeInutilizacao4Stub.NfeResultMsg.class.equals(
                        type)) {
                return NFeInutilizacao4Stub.NfeResultMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
