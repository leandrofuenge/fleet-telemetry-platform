...
public class GeocodingCache {
     ...
     */
    private GeocodingCache(Long id, BigDecimal latArred, BigDecimal lngArred,
            String pais, String estado, String cidade, String bairro,
            String logradouro, String cep, String nomeLocal,
            String tipoLocal, Boolean isUrbano, Integer precisaoMetros,
            String fonte, LocalDateTime consultaEm, LocalDateTime expiraEm) {
        this.id = id;
    ...
    public static final class Builder {
        ...
        private Boolean isUrbano;
        private Integer precisaoMetros;
        private String fonte = "NOMINATIM"; // valor padrão
        private LocalDateTime consultaEm;
        private LocalDateTime expiraEm;
        ...
        public GeocodingCache build() {
            return new GeocodingCache(
                    id, latArred, lngArred,
                    pais, estado, cidade, bairro,
                    logradouro, cep, nomeLocal,
                    tipoLocal, isUrbano, precisaoMetros,
                    fonte, consultaEm, expiraEm);
        }
    }
}