...
public class Telemetria {
    ...
    @Column(name = "preservar_dados", nullable = false)
    private Boolean preservarDados = false;
    ...
    public static final class Builder {
        ...
        public Builder impreciso(Boolean v) {
            this.impreciso = v;
            return this;
        }
        ...
        public Telemetria build() {
            ...
            t.impreciso = impreciso;   // ✅ CORREÇÃO AQUI
            return t;
        }
    }
    ...
    public Boolean isPreservarDados() { return preservarDados; }
    public void setPreservarDados(Boolean preservarDados) { this.preservarDados = preservarDados; }
    
    public Boolean getImpreciso() {
        return impreciso;
    }

    public void setImpreciso(Boolean impreciso) {
